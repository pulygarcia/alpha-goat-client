...
Admin-only moderation queue at `/admin`: listing PENDING alfajores with paginated
navigation, approve and reject-with-reason actions, and non-admin 404 gating.
